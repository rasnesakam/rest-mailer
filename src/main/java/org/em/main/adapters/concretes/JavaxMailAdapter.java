...
public class JavaxMailAdapter implements MailAdapter {
    ...
    @Autowired
    public JavaxMailAdapter(PropertiesManager propertiesManager){
    ...
    public void send() {
        ...
        Properties properties = propertiesManager.getProperties(propertiesManager.getType(mail.getFrom()));
